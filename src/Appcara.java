 ...
 * @author USUARIO
 */
public class Appcara extends javax.swing.JFrame {

    /**
     * Creates new form Appcara
     */
    public Appcara() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\USUARIO\\Downloads\\telefono.png")); // NOI18N
    ...
    private void btInicioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btInicioActionPerformed
        String textoNomb; 
        textoNomb=txtNombre.getText();
        if (textoNomb.isEmpty() || textoNomb.length() <1){
            JOptionPane.showMessageDialog(this, "Ingresa tu nombre para continuar.");
            
        } else {
            JOptionPane.showMessageDialog(this, "Bienvenido "+textoNomb+" a la mejor agenda del mundo.");
            Principal verformulario2=new Principal(textoNomb); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Appcara.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
